...
project = "aiida-castep-addons"
copyright_first_year = "2022"
copyright_owners = "Alp Samli"
...
release = aiida_castep_addons.__version__
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_castep_addons")
