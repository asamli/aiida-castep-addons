...
def test_band_plot_wc(mock_castep_code):
    ...
    bld.calc.parameters = {"xc_functional":"pbesol", "cut_off_energy":250, "symmetry_generate":True}
    ...
    bld.metadata.description = 'Density of states and band structure of silicon with PBEsol functional'
