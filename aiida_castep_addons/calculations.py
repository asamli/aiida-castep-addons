# -*- coding: utf-8 -*-
"""
Calculations provided by aiida_castep_addons.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.inputs['metadata']['options']['parser_name'].default = 'castep_addons'
        ...
        spec.output('castep_addons', valid_type=SinglefileData, help='diff between file1 and file2.')
